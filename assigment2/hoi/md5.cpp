...
void *
__md5_read_ctx (const struct md5_ctx *ctx,
void *resbuf)
{
...
/* Process the remaining bytes in the internal buffer and the usual
   ...
   aligned for a 32 bits value.  */
void *
__md5_finish_ctx (struct md5_ctx *ctx,
void *resbuf)
{
...
#define BLOCKSIZE 4096
 ...
 next round of the loop another block can be read.  */
  ...
  if (sum > 0)
    __md5_process_bytes (buffer, sum, &ctx);
...
/* Compute MD5 message digest for LEN bytes beginning at BUFFER.  The
   ...
   digest.  */
void *
__md5_buffer (const char *buffer,
size_t len,
void *resblock)
{
  struct md5_ctx ctx;
...
void
__md5_process_bytes (const void *buffer,
size_t len,
struct md5_ctx *ctx)
{
...
void
__md5_process_block (const void *buffer,
size_t len,
struct md5_ctx *ctx)
{
